const [rows, columns, queries] = [6,6,[[2,2,5,4],[3,3,6,6],[5,1,6,3]]];
// const [rows, columns, queries] = [3,3,[[1,1,2,2],[1,2,2,3],[2,1,3,2],[2,2,3,3]]];
// const [rows, columns, queries] = [100,97,[[1,1,100,97]]];
